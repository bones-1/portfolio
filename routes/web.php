...
Route::prefix('projects')->group(function () {
    ...
    Route::get('/market', [SubscribeController::class, 'index'])->name('projects.markets.index');
    Route::get('/market/{product}', [SubscribeController::class, 'show'])->name('projects.markets.show');
